      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 flex items-center justify-center rounded-full bg-white shadow-sm">
            <Motorbike className="h-8 w-8 text-gray-800" />
          </div>
          <h2 className="mt-6 text-3xl font-light text-gray-900">Base de datos DGMC</h2>
          <p className="mt-2 text-gray-500">Inicia sesión</p>
        </div>
